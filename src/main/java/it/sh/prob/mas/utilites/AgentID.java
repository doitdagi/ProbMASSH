...
public final class AgentID {
	...
	public static final String BATHROOM_LUMINIOSITY_SENSOR_AID ="bathroom_leminosity_sensor";
	...
	public static final String BEDROOM_DF_AID = "bedroom_df";
	public static final String BEDROOM_NEGOTIATOR_AID ="bedroom_negotiator";
	public static final String BEDROOM_REASONER_AID ="bedroom_reasoner";
	...
	public static final String KITCHEN_DF_AID = "kitchen_df";
	public static final String KITCHEN_NEGOTIATOR_AID ="kitchen_negotiator";
	public static final String KITCHEN_REASONER_AID ="kitchen_reasoner";
	...
	public static final String LIVINGROOM_DF_AID = "livingroom_df";
	public static final String LIVINGROOM_NEGOTIATOR_AID ="livingroom_negotiator";
	public static final String LIVINGROOM_REASONER_AID ="livingroom_reasoner";
